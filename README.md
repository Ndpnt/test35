# Declarations of terms tracked in the *test35* collection
...
You can [explore the tracked versions](https://github.com/Ndpnt/test35-versions) interactively or [download them as a dataset](https://github.com/Ndpnt/test35-versions/releases) in the `Ndpnt/test35-versions` repository.
